...
// Public page — excluded from proxy.ts (auth middleware). Shows the
// invite UI only. Auth + client linking happens at
// /api/invite/accept/[token], which IS covered by middleware.
