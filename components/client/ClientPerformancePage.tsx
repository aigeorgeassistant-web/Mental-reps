...
export function ClientPerformancePage() {
  ...
  return (
    <div style={S.page}>
      {/* Top bar */}
      <div style={S.topbar}>
        <a href="/client/dashboard" style={{ fontSize: 12, color: "#888", textDecoration: "none" }}>← Builder</a>
        <span style={{ fontSize: 14, fontWeight: 500 }}>My Performance</span>
